...
---@param z number 
---@param entity number 
function TaskJump2(ped, x, y, z, entity) end
...
---@param p3 number 
---@param flags number 
function TaskBoardVehicle2(ped, p1, p2, p3, flags) end
...
---@param p7 any 
---@param p8 any 
function TaskVehicleDriveToCoord2(ped, p1, p2, p3, p4, p5, p6, p7, p8) end
...
---@param p7 any 
---@param p8 any 
function N_undefined(ped, p1, p2, p3, p4, p5, p6, p7, p8) end
...
---@param ped number 
---@param args any 
function TaskScriptedAnimation(ped, args) end
...
---@param p6 any 
---@param p7 number 
function TaskItemInteraction2(ped, propNameGxt, prop, propId, itemInteractionState, p5, p6, p7) end
...
---@param p5 any 
---@param p6 number 
function TaskItemInteraction3(ped, item, guid, p3, p4, p5, p6) end
...
---@param item number | string 
---@param p2 number 
function N_undefined(ped, item, p2) end
...
---@param z number 
---@param p4 number 
function N_undefined(ped, x, y, z, p4) end
...
---@param p2 any 
---@param p3 any 
function TaskPerformSequence2(p0, p1, p2, p3) end
...
---@param p7 number 
---@param p8 number 
function TaskVehicleDriveToDestination2(vehicle, x, y, z, speed, p5, p6, p7, p8) end
...
---@param p5 number 
---@param p6 any 
function TaskVehicleDriveToPoint2(vehicle, x, y, z, p4, p5, p6) end
...
---@param ped number 
---@param args any 
function TaskShootWithWeapon(ped, args) end
...
---@param p3 any 
---@param p4 any 
function N_undefined(entity, targetEntity, duration, p3, p4) end
...
---@param ped number 
---@param heading number 
function TaskClimb2(ped, heading) end
...
---@param p7 any 
---@param p8 any 
function N_undefined(p0, p1, p2, p3, p4, p5, p6, p7, p8) end
...
---@param p4 any 
---@param p5 any 
function TaskCombatPed3(p0, p1, p2, p3, p4, p5) end
...
---@param p6 any 
---@param p7 any 
function TaskGuardAssignedDefensiveArea2(ped, p1, p2, p3, p4, p5, p6, p7) end
...
---@param p6 number 
---@param p7 boolean 
function TaskUseScenarioPoint2(ped, ped2, p2, p3, p4, p5, p6, p7) end
...
---@param p5 number 
---@param p6 boolean 
function TaskStartScenarioInPlace2(ped, p1, p2, p3, p4, p5, p6) end
...
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param scenario number 
function N_undefined(scenario) end
...
---@param p2 any 
---@param p3 any 
function TaskThrowProjectile2(p0, p1, p2, p3) end
...
---@param p6 any 
---@param p7 any 
function TaskPatrol2(p0, p1, p2, p3, p4, p5, p6, p7) end
...
---@param point number 
---@param coord vector3 
function WaypointRecordingGetCoord(waypointRecording, point, coord) end
...
---@param y number 
---@param z number 
function N_undefined(waypointRecording, x, y, z) end
...
---@param p8 any 
---@param p9 any 
function TaskVehicleFollowWaypointRecording2(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9) end
...
---@param animDict const char 
---@param flags number 
function TaskMoveNetworkByNameWithInitParams(ped, moveNetworkDefName, taskData, p3, p4, animDict, flags) end
...
---@param targetPed number 
---@param p2 number 
function TaskCutFreeHogtiedTargetPed2(ped, targetPed, p2) end
...
function GetHerbCompositeNumEntities(compositeId, outEntities) end
...
---@param p0 any 
---@param item number | string 
function N_undefined(p0, item) end
...
---@param object number 
---@param ped number 
function N_undefined(object, ped) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param hatObject number 
function IsHatBeingPickedUp2(hatObject) end
...
---@param p7 boolean 
---@param flag number 
function TaskIntimidated2(victim, attacker, p2, p3, p4, everyFrame, p6, p7, flag) end
...
---@param ped number 
---@param p1 any 
function GetTaskFishing(ped, p1) end
...
---@param p5 number 
---@param p6 number 
function N_undefined(ped, entity, p2, p3, p4, p5, p6) end
