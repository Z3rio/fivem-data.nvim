...
---@return boolean retval `true`: Indicates if the specific help message has been displayed.\
...
---@param durationMultiplier number 1.0 is normal, 2.0 is twice as long, and 0.5 is half its normal display time.
---@return number retval 
function SetNotificationMessage4(picTxd, picTxn, flash, iconType, nameStr, subtitleStr, durationMultiplier) end
...
---@return number retval Hardcoded to always return 1 (int)
