...
---end)```
---@param ped number The ped you want to take the "headshot" of.
---@return number retval It returns a Pedheadshot handle, which can be used by natives such as [GET_PEDHEADSHOT_TXD_STRING](https://docs.fivem.net/natives/?\_0xDB4EACD4AD0A5D6B)
...
---@param ped number The ped to set attributes to.
