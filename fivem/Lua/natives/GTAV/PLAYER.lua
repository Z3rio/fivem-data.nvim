...
---@param player number The player to disable rewards
...
---@param player number The player for which to disable combat methods.
...
---@return number retval A vehicle handle containing the last player's vehicle.
...
---@return boolean retval Whether or not the player is actively performing a certain type of traffic violation.
...
---  end
---end)```
---@param player number player to restore the stamina for
...
---@param player number The Player ID for whom you want to set this behavior.
