...
---end```
---@return number retval *   Returns 5 if the player is in the air (in a state of switch).
...
---end```
---@param ped number The Ped (player character) for which the switch is initiated.
