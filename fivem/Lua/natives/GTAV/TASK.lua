...
---    end
---end)```
---@param ped number The ped the task is running on
---@param taskHash number | string The hash of the task
---@return number retval The status of the script-assigned task.
