...
---@param vehicle number The vehicle to stop.
...
---@param vehicle number The vehicle that will be attached
...
---@return number retval A script handle (fwScriptGuid index) for the train, or 0 if the train failed to be created.
...
---@param vehicle number The vehicle to check for the presence of a searchlight.
---@return boolean retval Returns `true` if the vehicle has a searchlight, `false` otherwise.
...
---@param modelHash number | string The model hash of the boat.
---@return number retval Returns the agility value of the specified boat as a float number.
...
---@param vehicle number Vehicle to get the state of
---@return number retval *   0 when closed/up, the vehicle is not a convertible or the vehicle is null/not provided
*   1 when closing
*   2 when open/down
*   3 when opening
...
---end```
---@param vehicle number The vehicle to check. This should be a boat-type vehicle.
---@return boolean retval Returns `true` if the specified boat is capsized, `false` otherwise.
...
---@param modelHash number | string The model hash of the vehicle.
---@return string retval Returns the display label of the manufacturer if the vehicle model is recognized, or "CARNOTFOUND" if the hash does not correspond to any known vehicle model.
...
---@param vehicle number The vehicle for which to obtain the acceleration.
---@return number retval Returns the acceleration value of the specified vehicle as a float number.
...
---end```
---@param vehicle number The vehicle to get the cause of destruction of.
---@return number | string retval A hash representing the destruction cause. These can be weapon hashes.
...
---@return number retval A float representing angle of door mapped from 0.0 to 1.0
...
---@param vehicle number The vehicle for which to obtain the estimated max speed.
---@return number retval Returns the estimated maximum speed of the specified vehicle as a float number.
...
---@param vehicle number 
---@param doorIndex number 
---@return number retval Returns vehicle door lock state previously set with [`SET_VEHICLE_INDIVIDUAL_DOORS_LOCKED`](#\_0xBE70724027F85BCD)
...
---@param vehicle number The vehicle to check for mercenary status.
---@return boolean retval Returns `true` if the vehicle is a mercenary vehicle, `false` otherwise.
...
---@param vehicle number The vehicle to get the mod of.
---@param modType number Refer to eVehicleModType in [`SET_VEHICLE_MOD`](#\_0x6AF0636DDEDCB6DD).
---@return number retval Returns the current modIndex, or `-1` if the mod is stock.
...
---@param vehicle number 
---@return boolean retval Returns false if siren and lights are disabled or true if they are enabled.
...
---@param vehicle number The vehicle handle to toggle obstacle avoidance for.
...
---@param vehicle number The vehicle to which the roof state will be applied.
...
---@param vehicle number The vehicle to which the toggle will be applied.
...
---@param vehicle number Helicopter for which the combat offset is being set.
...
---@param vehicle number The vehicle to which the ratio will be applied.
...
---end```
---@param vehicle number The vehicle to apply this setting to.
...
---@param vehicle number Plane to which the damage scale adjustment will be applied.
...
---end)```
---@param vehicle number The vehicle to which the locking state will be applied.
...
---@param vehicle number The vehicle to be affected by this setting.
...
---@param vehicle number The specific vehicle to be set for influencing the wanted level.
