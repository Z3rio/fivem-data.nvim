...
---@param ped number 
---@param listenerName const char 
function N_undefined(listeningToPed, ped, listenerName) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param convoRoot const char 
---@param animScene animscene 
function N_undefined(convoRoot, animScene) end
...
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param convoRoot const char 
function N_undefined(convoRoot) end
...
function N_undefined(p0, currentScriptedConvoLine) end
...
function N_undefined(convoRoot, singleLineIndex) end
...
---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param audSpeechEvent const char 
function N_undefined(audSpeechEvent) end
...
---@param audioName const char 
---@param audioRef const char 
function N_undefined(audioName, audioRef) end
...
---@param params any 
function PlayPedAmbientSpeechNative(speaker, params) end
...
---@param z number 
---@param params any 
function PlayAmbientSpeechFromPositionNative(x, y, z, params) end
...
---@param p1 number 
---@param p2 boolean 
function N_undefined(speechEventType, p1, p2) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param speechEventType number 
function N_undefined(speechEventType) end
...
---@param ropeId number 
---@param name const char 
function N_undefined(ropeId, name) end
...
---@param p6 any 
function N_undefined(p0, p1, x, y, z, isSrlLoaded, p6) end
...
---@param p3 number 
---@param p4 any 
function N_undefined(entity, p1, p2, p3, p4) end
