...
function N_undefined(iTrackedPoint) end
...
function N_undefined(component) end
...
---@param p7 number 
---@param p8 boolean 
function AddBloodPool2(x, y, z, p3, size, p5, permanent, p7, p8) end
...
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param effectName const char 
---@param effectName2 const char 
---@param p2 any 
---@param p3 any 
function N_undefined(effectName, effectName2, p2, p3) end
...
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param effectName const char 
function N_undefined(effectName) end
...
---@param p2 boolean 
---@param p3 boolean 
function N_undefined(effectName, p1, p2, p3) end
...
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param effectNameHash number | string 
function N_undefined(effectNameHash) end
...
---@param p2 boolean 
---@param p3 boolean 
function AnimpostfxHasEventTriggeredByStackhash(effectNameHash, p1, p2, p3) end
...
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param personaPhotoLocalCacheType number 
function N_undefined(personaPhotoLocalCacheType) end
...
---@param p5 number 
---@param heading number 
function N_undefined(p0, x, y, z, p4, p5, heading) end
...
---@param layer2 number 
---@param layer3 number 
function GetEntityMaskLayers(entity, layer0, layer1, layer2, layer3) end
...
---@param layer2 number 
---@param layer3 number 
function SetEntityMaskLayers(entity, layer0, layer1, layer2, layer3) end
