...
function N_undefined(p0, costShop) end
...
function ItemdatabaseCreateItemCollection(p0, size, comparisonType) end
...
function ItemdatabaseGetComponentItem(collectionId, index, p2) end
...
---@param index number 
---@param menuKey any 
function N_undefined(p0, index, menuKey) end
...
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param award number | string 
function N_undefined(award) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param award number | string 
---@param index number 
---@param currency number | string 
function ItemdatabaseFilloutAwardItemInfo(award, index, currency) end
...
---@param p1 any 
---@param p2 any 
function N_undefined(award, p1, p2) end
...
---@param tagType number | string 
---@param p2 any 
function N_undefined(p0, tagType, p2) end
