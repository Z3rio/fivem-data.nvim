...
---@param p3 number 
---@param p4 boolean 
function SetWeatherType2(weatherType, p1, p2, p3, p4) end
...
function GetCurrWeatherState(weatherType1, weatherType2, percentWeather2) end
...
---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param weather number | string 
---@param p1 number | string 
function GetForcedWeather(weather, p1) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param weatherType number | string 
function N_undefined(weatherType) end
...
---@param p4 boolean 
function GetGroundZFor3dCoord(x, y, z, groundZ, p4) end
...
---@param p11 number 
---@param p12 number 
function GetLinePlaneIntersection(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12) end
...
---@param bitFlags any 
---@param flag number 
function IsBitFlagSet(bitFlags, flag) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param bitFlags any 
function IsAnyBitFlagSet(bitFlags) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param bitFlags any 
function CountBitFlags(bitFlags) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param bitFlags any 
---@param flag number 
function SetBitFlag(bitFlags, flag) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param bitFlags any 
---@param flag number 
function ClearBitFlag(bitFlags, flag) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param bitFlags any 
function ClearAllBitFlags(bitFlags) end
...
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param args any 
function FireSingleBullet(args) end
...
---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
function ShouldUseMetricMeasurements2() end
...
---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
function ShouldUse24HourClock() end
...
function GetCoordsOfProjectileTypeWithinDistance(ped, weaponHash, distance, outCoords, p4, mustBeOwnedByThisPed) end
...
---@param p5 boolean 
---@param mustBeOwnedByThisPed boolean 
function GetProjectileOfProjectileTypeWithinDistance(ped, weaponHash, distance, outCoords, outProjectile, p5, mustBeOwnedByThisPed) end
...
---@param src any 
---@param size number 
function CopyScriptStruct(dst, src, size) end
...
---@param p7 any 
---@param p8 any 
function CreateIncident(dispatchService, x, y, z, numUnits, radius, outIncidentID, p7, p8) end
...
---@param radius number 
---@param outIncidentID number 
function CreateIncidentWithEntities(dispatchService, x, y, z, itemSet, radius, outIncidentID) end
...
---@param p1 any 
---@param p2 any 
function ScriptRaceGetPlayerSplitTime(p0, p1, p2) end
...
function CreateAiMemory(args, aiMemoryType) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param args any 
---@param p1 number 
function GetAiPedDoesHaveEventMemory(args, p1) end
...
---@param p4 any 
---@param p5 any 
function LootTablesGetInfo(ped, p1, p2, lootTableKey, p4, p5) end
...
---@param p1 boolean 
function N_undefined(compositeId, p1) end
