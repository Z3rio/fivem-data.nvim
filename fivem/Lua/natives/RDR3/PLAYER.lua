...
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param player number 
function GetPlayerPed2(player) end
...
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param maxWantedLevel number 
function SetMaxWantedLevel2(maxWantedLevel) end
...
---@param p2 boolean 
---@param p3 boolean 
function GetPlayerInteractionTargetEntity(player, outEntity, p2, p3) end
...
---@param player number 
---@param ped number 
function N_undefined(player, ped) end
...
function N_undefined(player, p1, enable) end
...
---@param player number 
---@param toggle boolean 
function N_undefined(player, toggle) end
...
function N_undefined(player, ped, useSteerassist) end
...
---@param p7 const char 
function N_undefined(player, ped, p2, x, y, z, targetEntity, p7) end
...
---@param player number 
---@param name const char 
function N_undefined(player, name) end
...
---@param p1 number 
---@param p2 any 
function N_undefined(player, p1, p2) end
...
---@param p3 number 
---@param p4 number 
function N_undefined(player, p1, p2, p3, p4) end
...
---@param p4 number 
---@param p5 any 
function N_undefined(player, p1, p2, p3, p4, p5) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param player number 
---@param bitflag number 
function N_undefined(player, bitflag) end
...
---@param entity2 number 
---@param p2 any 
function N_undefined(entity1, entity2, p2) end
...
---@param p1 boolean 
---@param p2 any 
function EagleEyeSetColor(player, p1, p2) end
...
---@param player number 
---@param p1 number 
function EagleEyeSetTrackingUpgrade2(player, p1) end
...
function N_undefined(category, emote) end

---This native does not have an official description.
---[Native Documentation](https://alloc8or.re/rdr3/nativedb/?n=undefined)
---@param emote number | string 
function N_undefined(emote) end
...
---@param p2 boolean 
function N_undefined(player, weapon, p2) end
...
function GetDiscoverableNameHashAndTypeForEntity(entity, type) end
...
function N_undefined(location) end
